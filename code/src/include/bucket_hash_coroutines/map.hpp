...
static inline std::size_t next_power_of_2(std::size_t n);
...
public:
    ...
    explicit Map(std::size_t const max_capacity_, const Hasher hashfn = Hasher());
    ...
    , hasher(hashfn)
{
    ...
    auto const init_capacity = next_power_of_2(max_capacity) >> 1;
